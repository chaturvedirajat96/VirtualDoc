...
public class Hands extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView11.setPaintFlags(textView11.getPaintFlags()| Paint.UNDERLINE_TEXT_FLAG);
    }



    public void onHandsCheckboxClicked(View v) {
    ...
    public void onHandsButtonClicked(View v){
        for (int j = 0; j < 7; j++) {
            if (A[j] == ar[j]) {
                ca++;
       ...
       /* TextView textView18 = (TextView) findViewById(R.id.textView18);*/
        if (ca>=cf && ca>=cs) {
            ...
            Intent i=new Intent(Hands.this,result.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_hands, menu);
        return true;
    }
